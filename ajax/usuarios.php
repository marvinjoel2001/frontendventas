...
case 'listar':
	...
	break;
		...
		if (isset($fetch))
	    {
			...
			in_array(3,$valores)?$_SESSION['Deudas']=1:$_SESSION['Deudas']=0;
			...
			in_array(8,$valores)?$_SESSION['Garantia']=1:$_SESSION['Garantia']=0;
			in_array(9,$valores)?$_SESSION['Multas']=1:$_SESSION['Multas']=0;
			in_array(10,$valores)?$_SESSION['Productos']=1:$_SESSION['Productos']=0;
			in_array(11,$valores)?$_SESSION['Entradas']=1:$_SESSION['Entradas']=0;
			in_array(12,$valores)?$_SESSION['Ventas']=1:$_SESSION['Ventas']=0;
