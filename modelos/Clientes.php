...
Class Clientes
{
	...
	public function selectidprestamo()
	{
		$sql="SELECT c.nombre ,p.idprestamo FROM prestamos p INNER JOIN clientes c ON p.idcliente=c.idcliente WHERE p.estado=1 ORDER BY c.nombre ASC";
		return ejecutarConsulta($sql);		
	}
